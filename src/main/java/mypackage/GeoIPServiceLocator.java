...
public class GeoIPServiceLocator extends org.apache.axis.client.Service implements mypackage.GeoIPService {
 ...
 */
    ...
    public mypackage.GeoIPServiceSoap_PortType getGeoIPServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.GeoIPServiceSoap_PortType getGeoIPServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.GeoIPServiceSoap_BindingStub _stub = new mypackage.GeoIPServiceSoap_BindingStub(portAddress, this);
    ...
    public mypackage.GeoIPServiceSoap_PortType getGeoIPServiceSoap12() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public mypackage.GeoIPServiceSoap_PortType getGeoIPServiceSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.GeoIPServiceSoap12Stub _stub = new mypackage.GeoIPServiceSoap12Stub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.GeoIPServiceSoap_BindingStub _stub = new mypackage.GeoIPServiceSoap_BindingStub(new java.net.URL(GeoIPServiceSoap_address), this);
                _stub.setPortName(getGeoIPServiceSoapWSDDServiceName());
                return _stub;
            }
            if (mypackage.GeoIPServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.GeoIPServiceSoap12Stub _stub = new mypackage.GeoIPServiceSoap12Stub(new java.net.URL(GeoIPServiceSoap12_address), this);
                _stub.setPortName(getGeoIPServiceSoap12WSDDServiceName());
                return _stub;
            }
        }
